                        ...
                        switch (request.HttpMethod)
                        {
                            case "GET":
                                ...
                                else
                                {
                                    ...
                                    if (ServerConfiguration.MOTD == null || ServerConfiguration.MOTD == string.Empty)
                                        ...
                                        Medius_Announcement_Read = Encoding.UTF8.GetBytes(ServerConfiguration.MOTD);
                        ...
                        switch (request.HttpMethod)
                        {
                            case "GET":
                                ...
                                else
                                {
                                    ...
                                    bool fileExists = File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}HUBPS3_SVML/fileservices/{fileNameBeginsWith}");
                                ...
                                else
                                {
                                    if (fileNameBeginsWith != null)
                                    {
                                        ...
                                        using (MemoryStream ms = new MemoryStream())
                                        {
                                            ...
                                            using (FileStream fs = new FileStream(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}HUBPS3_SVML/fileservices/{fileNameBeginsWith}", FileMode.Open))
                                            {
                            ...
                            case "POST":
                                ...
                                else
                                {
                                    ...
                                    using (MemoryStream ms = new MemoryStream())
                                    {
                                        ...
                                        using (FileStream fs = new FileStream(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}HUBPS3_SVML/tracking/{fileNameBeginsWith}", FileMode.OpenOrCreate))
                                        {
                            ...
                            case "POST":
                                ...
                                else
                                {
                                    ...
                                    using (MemoryStream ms = new MemoryStream())
                                    {
                                        ...
                                        using (FileStream fs = new FileStream(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}HUBPS3_SVML/fileservices/{toUpload}", FileMode.OpenOrCreate))
                                        {
