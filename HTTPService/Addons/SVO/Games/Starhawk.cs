                        ...
                        switch (request.HttpMethod)
                        {
                            case "GET":
                                ...
                                else
                                {
                                    ...
                                    if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}fileservices/{fileNameBeginsWith}"))
                                    {
                                        ...
                                        */
                                        ...
                                        if (ros.CanWrite)
                                        {
                                            try
                                            {
                                                ...
                                                ros.Write(File_Service, 0, File_Service.Length);
                                            }
                                            catch (Exception)
                                            {
                                                // Not Important;
                        ...
                        switch (request.HttpMethod)
                        {
                            case "GET":
                                ...
                                else
                                {
                                    ...
                                    toDownload = HttpUtility.ParseQueryString(request.Url.Query).Get("fileNameBeginsWith");

                                    using (FileStream fs = new FileStream(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}fileservices/{toDownload}", FileMode.Open))
                                    {
                            ...
                            case "POST":
                                ...
                                else
                                {
                                    ...
                                    using (MemoryStream ms = new MemoryStream())
                                    {
                                        ...
                                        using (FileStream fs = new FileStream(Directory.GetCurrentDirectory() + $"{ServerConfiguration.SVOStaticFolder}fileservices/{toUpload}", FileMode.OpenOrCreate))
                                        {
                            ...
                            case "GET":
                                ...
                                else
                                {
                                    ...
                                    byte[] stats_BinaryStatsDownload_Submit = Encoding.UTF8.GetBytes("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
                                            ...
                                            "    </Server_Error>\r\n" +
                                            "    <logoutURL>http://starhawk-prod2.svo.online.scea.com:10061/BOURBON_XML/account/Account_Logout.do</logoutURL>\r\n" +
                                            "</XML>\r\n" +
                                            " \r\n");
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(stats_BinaryStatsDownload_Submit, 0, stats_BinaryStatsDownload_Submit.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(game_Create_Submit, 0, game_Create_Submit.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_homw, 0, clan_homw.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_CreateWithTag_Submit, 0, clan_CreateWithTag_Submit.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_ViewInvites, 0, clan_ViewInvites.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_GetClanPlayers, 0, clan_GetClanPlayers.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_ViewSentInvites, 0, clan_ViewSentInvites.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(clan_ReadNews, 0, clan_ReadNews.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
                                ...
                                else
                                {
                                    ...
                                    if (ros.CanWrite)
                                    {
                                        try
                                        {
                                            ...
                                            ros.Write(Calendar_GetEvents, 0, Calendar_GetEvents.Length);
                                        }
                                        catch (Exception)
                                        {
                                            // Not Important;
