...
namespace MultiServer.HTTPService.Addons.PlayStationHome.VEEMEE
{
    ...
    {
        public static Task getobjectslot(HttpListenerRequest request, HttpListenerResponse response)
        {
            int max_slot = 0;
            string slot_name = "";
            string session_key = "";
        ...
        public static Task remove(HttpListenerRequest request, HttpListenerResponse response)
        {
            int slot_num = 0;
            string slot_name = "";
            string session_key = "";
        ...
        public static Task heartbeat(HttpListenerRequest request, HttpListenerResponse response)
        {
            string session_key = "";
            string scene_id = "";
            string region = "";
