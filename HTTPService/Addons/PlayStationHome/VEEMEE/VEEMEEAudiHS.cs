    ...
    public class VEEMEEAudiHS
    {
        public static async Task audiHSGetTopUser(HttpListenerRequest request, HttpListenerResponse response)
        {
            ...
            if (key == "3Ebadrebr6qezag8")
            {
                ...
                if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_VEEMEE/Audi_Vrun/GeneralHSML.hsml"))
                    clientresponse = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_VEEMEE/Audi_Vrun/GeneralHSML.hsml", HTTPPrivateKey.HTTPPrivatekey);
        ...
        public static async Task audiHSSetUserData(HttpListenerRequest request, HttpListenerResponse response)
        {
            ...
            if (key == "3Ebadrebr6qezag8")
            {
                ...
                await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_VEEMEE/Audi_Vrun/User_Score/{psnid}.hsml", HTTPPrivateKey.HTTPPrivatekey, resultData, false);
        ...
        public static async Task audiHSGetUserData(HttpListenerRequest request, HttpListenerResponse response)
        {
            ...
            if (key == "3Ebadrebr6qezag8")
            {
                if (psnid != "nil")
                {
                    ...
                    {
                        clientresponse = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_VEEMEE/Audi_Vrun/User_Score/{psnid}.hsml", HTTPPrivateKey.HTTPPrivatekey);
                    }
                    else
                    {
        ...
        public static async Task audiHSGlobalTable(HttpListenerRequest request, HttpListenerResponse response)
        {
            ...
            if (key == "3Ebadrebr6qezag8")
            {
                byte[] clientresponse = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_VEEMEE/Audi_Vrun/GeneralHSML.hsml", HTTPPrivateKey.HTTPPrivatekey);
