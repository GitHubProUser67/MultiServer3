...
namespace MultiServer.HTTPService.Addons.PlayStationHome.HELLFIREGAMES
{
    public class HOMETYCOONProcessor
    {
        public static byte[] RequestNPTicket(string boundary, MemoryStream copyStream)
        {
            ...
            if (ticketData == null)
                return Encoding.UTF8.GetBytes($"<response><Thing>voodooperson05;{SSFWProcessor.ssfwgenerateguid("IAMN0TAPERSON", "Y3AH")}</Thing></response>");
            else
            {
        ...
        public static byte[] RequestTownInstance(string UserID, string DisplayName, string phpSessionId)
        {
            string hash = "";
        ...
        public static byte[] QueryServerGlobals(string UserID)
        {
        ...
        public static byte[] QueryPrices()
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Prices.xml"))
                result = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Prices.xml", HTTPPrivateKey.HTTPPrivatekey);
        ...
        public static byte[] QueryBoosters()
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Boosters.xml"))
                result = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Boosters.xml", HTTPPrivateKey.HTTPPrivatekey);
        ...
        public static byte[] QueryHoldbacks()
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Holdbacks.xml"))
                result = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/Holdbacks.xml", HTTPPrivateKey.HTTPPrivatekey);
        ...
        public static byte[] QueryRewards(string UserID)
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_Rewards.xml"))
                returnvalue = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_Rewards.xml", HTTPPrivateKey.HTTPPrivatekey);

            if (returnvalue == null)
                returnvalue = Encoding.UTF8.GetBytes("");
        ...
        public static async Task<byte[]> QueryGifts(string UserID)
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_Gifts.xml"))
                returnvalue = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_Gifts.xml", HTTPPrivateKey.HTTPPrivatekey);
            else
            {
                await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_Gifts.xml", HTTPPrivateKey.HTTPPrivatekey, Encoding.UTF8.GetBytes("<Gift>111111</Gift>"), false);
        ...
        public static async Task<byte[]> RequestTown(string UserID, string InstanceID) // Not work very fine
        {
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{generatecityguid(InstanceID, UserID)}.xml"))
                return Misc.Combinebytearay(Misc.Combinebytearay(Encoding.UTF8.GetBytes("<Response>"), FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{generatecityguid(InstanceID, UserID)}.xml", HTTPPrivateKey.HTTPPrivatekey)), Encoding.UTF8.GetBytes("</Response>"));
            else
            {
                ...
                await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{generatecityguid(InstanceID, UserID)}.xml", HTTPPrivateKey.HTTPPrivatekey, xml, false);
        ...
        public static async Task<byte[]> RequestUser(string UserID)
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml"))
                returnvalue = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml", HTTPPrivateKey.HTTPPrivatekey);
            else
            {
                returnvalue = FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/DefaultProfile.xml", HTTPPrivateKey.HTTPPrivatekey);
                await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml", HTTPPrivateKey.HTTPPrivatekey, returnvalue, false);
            }
        ...
        public static async Task<byte[]> UpdateUser(string UserID, MultipartFormDataParser data) // Not work
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml"))
                xmlprofile = Encoding.UTF8.GetString(FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml", HTTPPrivateKey.HTTPPrivatekey));
            else
                xmlprofile = Encoding.UTF8.GetString(FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/DefaultProfile.xml", HTTPPrivateKey.HTTPPrivatekey));
            ...
            await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}.xml", HTTPPrivateKey.HTTPPrivatekey, Encoding.UTF8.GetBytes(modifiedXml), false);
        ...
        public static async Task<byte[]> CreateBuilding(string UserID, MultipartFormDataParser data) // Not work very fine
        {
            ...
            if (File.Exists(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{TownID}.xml"))
                xmlprofile = Encoding.UTF8.GetString(FileHelper.CryptoReadAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{TownID}.xml", HTTPPrivateKey.HTTPPrivatekey));
            ...
            await FileHelper.CryptoWriteAsync(Directory.GetCurrentDirectory() + $"{ServerConfiguration.HTTPStaticFolder}HOME_TYCOON/User_Data/{UserID}_{TownID}.xml", HTTPPrivateKey.HTTPPrivatekey, Encoding.UTF8.GetBytes(modifiedXmlData), false);
