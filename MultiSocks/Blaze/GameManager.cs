...
namespace SRVEmu.Blaze.GameManager
{
    ...
    {
        public static List<GameInfo> AllGames = new();
        public class GameInfo
        {
            ...
            public Blaze.Blaze.TdfDoubleList? ATTR;
            ...
            public void MakeATTR()
            {
                ...
                ATTR = Blaze.Blaze.TdfDoubleList.Create("ATTR", 1, 1, keys, data, Attributes.Count);
            }
            ...
            public List<Player.PlayerInfo> AllPlayers
            {
                get
                {
                    List<Player.PlayerInfo> piList = new();
                    if (Creator.isActive)
                        piList.Add(Creator);
