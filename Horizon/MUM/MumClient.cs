...
namespace Horizon.MUM
{
    ...
    {
        public static string? GetJsonServerResult(string ip, ushort port, string command)
        {
#if NET7_0
            try
            {
...
#pragma warning restore
        ...
        public static string? GetXMLServerResult(string ip, ushort port, string command)
        {
#if NET7_0
            try
            {
