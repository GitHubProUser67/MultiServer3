...
namespace Horizon.MUIS.Config
{
    public class ServerSettings
    {
        ...
        /// IP of the MUIS.
        /// </summary>
        public string MUISIp { get; set; } = VariousUtils.GetLocalIPAddress().ToString();
        #endregion
        ...
        /// </summary>
        public string NATIp { get; set; } = VariousUtils.GetFirstActiveIPAddress("natservice.pdonline.scea.com", "34.199.94.233", true);
        /// <summary>
