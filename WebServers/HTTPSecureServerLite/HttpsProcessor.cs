                ...
                if (!sent)
                {
                    ...
                    else if (Host == "server.lootgear.com" || Host == "alpha.lootgear.com")
                    {
                        ...
                        sent = await ctx.Response.Send(res);
                                                ...
                                                Host == "homeecqa.scej-nbs.jp") && ctx.Request.Method != null && ctx.Request.ContentType.StartsWith("multipart/form-data") && absolutepath.Contains("/eventController/") && absolutepath.EndsWith(".do"))
                    {
