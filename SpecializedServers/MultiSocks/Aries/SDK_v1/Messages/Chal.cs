        ...
        public override void Process(AbstractAriesServerV1 context, AriesClient client)
        {
            ...
            lock (room.ChallengeMap)
            {
                ...
                else if (user.PersonaName != null && room.ChallengeMap.ContainsKey(user.PersonaName))
                {
                    ...
                    if (GetInputCacheValue("PERS") == other._From)
                    {
                        //start the session.
                        ...
                        if (room.AllInGame)
                        {
                            ...
                            CustomLogger.LoggerAccessor.LogInfo("Starting a private game session between " + _From + " and " + GetInputCacheValue("PERS"));
                ...
                room.ChallengeMap[GetInputCacheValue("PERS")] = this;
            }
        }
    }
}