...
namespace MultiSocks.Aries.SDK_v1.Messages
{
    ...
    {
        public AbstractAriesServerV1 Context;
        public User? User;
        ...
        public AriesClient(AbstractAriesServerV1 context, TcpClient client, bool secure, string CN, string email, bool WeakChainSignedRSAKey)
        {
            this.secure = secure;
            Context = context;
            ClientTcp = client;
