...
public class ProtoSSLUtils
{
    ...
    private static X509Certificate PatchCertificateSignaturePattern(X509Certificate cCertificate)
    {
        ...
        var signature1Offset = DataTypesUtils.FindBytePattern(certDer, Sha1CipherSignature.Span);
        var signature2Offset = DataTypesUtils.FindBytePattern(certDer, Sha1CipherSignature.Span, signature1Offset + Sha1CipherSignature.Length);
