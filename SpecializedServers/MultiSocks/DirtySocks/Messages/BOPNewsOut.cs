namespace MultiSocks.DirtySocks.Messages
{
    public class BOPNewsOut : AbstractMessage
    {
        ...
        public string? LIVE_NEWS_URL { get; set; } = "\"http://gos.ea.com/easo/editorial/Burnout/2008/livedata/main.jsp?lang=%s&from=%s&game=Burnout&platform=pc&env=live&nToken=%s\"";
