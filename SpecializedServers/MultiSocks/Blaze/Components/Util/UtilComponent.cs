...
namespace MultiSocks.Blaze.Components.Util
{
    internal class UtilComponent : UtilComponentBase.Server
    {
        ...
        public override Task<PreAuthResponse> PreAuthAsync(PreAuthRequest request, BlazeRpcContext context)
        {
            ...
            LoggerAccessor.LogInfo($"[Blaze] - Util: Connection Id    : {connection.ID}");
            ...
            */
            ...
            fetchConfig.Add("pingPeriod", "15s");
            fetchConfig.Add("voipHeadsetUpdateRate", "1000");
            fetchConfig.Add("xlspConnectionIdleTimeout", "300");
            ...
            pingSiteInfoByAliasNames.Add("ea-sjc", qosPingSiteInfoSJC);
            pingSiteInfoByAliasNames.Add("rs-iad", qosPingSiteInfoIAD);
            pingSiteInfoByAliasNames.Add("rs-lhr", qosPingSiteInfolhr);



            PreAuthResponse responseData = new()
            {
                ...
                mServerVersion = "Blaze 3.15.08.0 (CL# 750727)", // Crysis 3 Blaze ver
        ...
        public override Task<PostAuthResponse> PostAuthAsync(NullStruct request, BlazeRpcContext context)
        {
            ...
            //return the response
            return Task.FromResult(postAuthResponse);
        }
        ...
        public override Task<FetchConfigResponse> FetchClientConfigAsync(FetchClientConfigRequest request, BlazeRpcContext context)
        {
            ...
            FetchConfigResponse responseData = new FetchConfigResponse()
            {
        ...
        public override Task<PingResponse> PingAsync(NullStruct request, BlazeRpcContext context)
        {
            ...
            //manually displaying some data
            LoggerAccessor.LogInfo($"[Blaze] - Util: Ping Connection Id    : {connection.ID}");
            ...
            {
                mServerTime = uint.Parse(dateTime.ToString("yyyyMMdd"))
            };
