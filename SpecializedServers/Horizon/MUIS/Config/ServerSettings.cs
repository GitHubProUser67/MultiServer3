...
namespace Horizon.MUIS.Config
{
    public class ServerSettings
    {
        ...
        /// IP of the MUIS.
        /// </summary>
        public string MUISIp { get; set; } = CyberBackendLibrary.TCP_IP.IPUtils.GetLocalIPAddress().ToString();
        #endregion
        ...
        /// </summary>
        public string? NATIp { get; set; } = CyberBackendLibrary.TCP_IP.IPUtils.GetFirstActiveIPAddress("natservice.pdonline.scea.com", "34.199.94.233", true) ?? "34.199.94.233";
        /// <summary>
