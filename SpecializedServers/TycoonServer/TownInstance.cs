...
namespace TycoonServer
{
    public class TownInstance
    {
        ...
        public static string? RequestTown(string UserID, string InstanceID, string DisplayName)
        {
            if (File.Exists($"{TycoonServerConfiguration.TycoonStaticFolder}/TYCOON/User_Data/{UserID}_{GenerateCityguid(InstanceID, UserID)}.xml"))
                return $"<Response>{File.ReadAllText($"{TycoonServerConfiguration.TycoonStaticFolder}/TYCOON/User_Data/{UserID}_{GenerateCityguid(InstanceID, UserID)}.xml")}</Response>";
            else
            {
                ...
                File.WriteAllText($"{TycoonServerConfiguration.TycoonStaticFolder}/TYCOON/User_Data/{UserID}_{GenerateCityguid(InstanceID, UserID)}.xml", xml);
