namespace SSFWServer
{
    public class SSFWMisc
    {
        ...
        public static List<string> homeEnvs = new List<string>()
        {
            "cprod", "cprodts", "cpreprod", "cpreprodb",
            "rc-qa", "rcdev", "rc-dev",
            "cqa-e", "cqa-a", "cqa-j", "cqa-h",
            "cqab-e", "cqab-a", "cqab-j", "cqab-h",
            "qcqa-e", "qcqa-a", "qcqa-j", "qcqa-h",
            "qcpreprod",
            "qcqab-e", "qcqab-a", "qcqab-j", "qcqab-h",
            "qcpreprodb",
            "coredev", "core-dev", "core-qa",
            "cdev", "cdev3", "cdeva", "cdevb", "cdevc"
        };
