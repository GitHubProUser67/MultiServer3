...
namespace BackendProject.WeBAPIs.VEEMEE.gofish
{
    public class GFScoreBoardData
    {
        public static string gfAPIPath { get; set; }
        ...
        public static void UpdateTodayScoreboardXml(string date, string apiPath)
        {
            Directory.CreateDirectory($"{apiPath}/VEEMEE/gofish");
        ...
        {
            SanityCheckLeaderboards($"{gfAPIPath}/VEEMEE/gofish", DateTime.Now.AddDays(-1));
        }
    }
}
