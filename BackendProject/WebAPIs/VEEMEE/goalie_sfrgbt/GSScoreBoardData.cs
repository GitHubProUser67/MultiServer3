...
namespace BackendProject.WeBAPIs.VEEMEE.goalie_sfrgbt
{
    public class GSScoreBoardData
    {
        public static string sbAPIPath {  get; set; }
        ...
        public static void UpdateAllTimeScoreboardXml(bool global, string apiPath)
        {
        ...
        public static void UpdateTodayScoreboardXml(bool global, string date, string apiPath)
        {
            string directoryPath = string.Empty;
            string filePath = string.Empty;
        ...
        {
            SanityCheckLeaderboards($"{sbAPIPath}/VEEMEE/goalie", DateTime.Now.AddDays(-1));
            SanityCheckLeaderboards($"{sbAPIPath}/VEEMEE/sfrgbt", DateTime.Now.AddDays(-1));
        }
    }
}
