...
namespace BackendProject.WeBAPIs.VEEMEE.olm
{
    public class olmScoreBoardData
    {
        public static string olmAPIPath { get; set; }
        ...
        public static void UpdateWeeklyScoreboardXml(string date, string apiPath)
        {
            Directory.CreateDirectory($"{apiPath}/VEEMEE/olm");
        ...
        {
            SanityCheckLeaderboards($"{olmAPIPath}/VEEMEE/olm", DateTime.Now.AddDays(-7));
        }
    }
}
