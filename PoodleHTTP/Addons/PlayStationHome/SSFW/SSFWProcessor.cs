...
namespace PSMultiServer.PoodleHTTP.Addons.PlayStationHome.SSFW
{
    public class SSFWProcessor
    {
        ...
        {
            string json = Encoding.UTF8.GetString(await FileHelper.CryptoReadAsync(filePath, SSFWPrivateKey.SSFWPrivatekey));
            ...
            await FileHelper.CryptoWriteAsync(filePath, SSFWPrivateKey.SSFWPrivatekey, Encoding.UTF8.GetBytes(mainFile.ToString()));
        }
        ...
        public static async Task SSFWupdatemini(string filePath, string postData)
        {
            ...
            await FileHelper.CryptoWriteAsync(filePath, SSFWPrivateKey.SSFWPrivatekey, Encoding.UTF8.GetBytes(jsonArray.ToString()));
        }
        ...
        public static async Task SSFWfurniturelayout(string filePath, string postData, string objectId)
        {
            ...
            await FileHelper.CryptoWriteAsync(filePath, SSFWPrivateKey.SSFWPrivatekey, Encoding.UTF8.GetBytes(jsonArray.ToString(Newtonsoft.Json.Formatting.None)));
        }

        public static async Task<string> SSFWgetfurniturelayout(string filePath, string objectId)
        {
            string json = Encoding.UTF8.GetString(await FileHelper.CryptoReadAsync(filePath, SSFWPrivateKey.SSFWPrivatekey));
