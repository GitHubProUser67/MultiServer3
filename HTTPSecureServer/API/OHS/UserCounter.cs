...
namespace HTTPSecureServer.API.OHS
{
    ...
    {
        public static string? Set(byte[] PostData, string ContentType, string directorypath, string batchparams)
        {
            ...
            if (!string.IsNullOrEmpty(dataforohs))
            {
                ...
                key = CryptoSporidium.Utils.GetValueFromJToken(Token, "key");
            ...
            else
            {
                if (string.IsNullOrEmpty(output))
                    ...
                    dataforohs = CryptoSporidium.OHS.JaminProcessor.JaminFormat($"{{ [\"status\"] = \"success\", [\"value\"] = {{ [\"{key}\"] = {output} }} }}");
            }

            return dataforohs;
        }

        public static string? Get_All(byte[] PostData, string ContentType, string directorypath, string batchparams)
        {
            string? dataforohs = null;
            string? output = null;
        ...
        public static string? Get(byte[] PostData, string ContentType, string directorypath, string batchparams)
        {
            string? dataforohs = null;
            string? output = null;
