...
namespace HTTPSecureServer.API.OHS
{
    ...
    {
        public static string? Community_Getscore(byte[] PostData, string ContentType, string directorypath, string batchparams)
        {
        ...
        public static string? Community_UpdateScore(byte[] PostData, string ContentType, string directorypath, string batchparams)
        {
            string? dataforohs = null;
            int output = 0;
            ...
            try
            {
                if (!string.IsNullOrEmpty(dataforohs))
                {
                    ...
                    if (Token != null)
                    {
                        ...
                        int inc = Convert.ToInt32(CryptoSporidium.Utils.GetValueFromJToken(Token, "inc"));
