...
using static HTTPSecureServer.API.OHS.UserCounter;
using System.Text;
...
namespace HTTPSecureServer.API.OHS
{
    public class User
    {
        public static string? Set(byte[] PostData, string ContentType, string directorypath, string batchparams, bool global)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(dataforohs))
                {
                    ...
                    object? value = CryptoSporidium.Utils.GetValueFromJToken(Token, "value");

                    object? key = CryptoSporidium.Utils.GetValueFromJToken(Token, "key");

                    object? user = CryptoSporidium.Utils.GetValueFromJToken(Token, "user");
                    ...
                    if (value != null)
                    {
                        if (JToken.FromObject(value).Type == JTokenType.String)
                            ...
                            // Handle array type
                            output = CryptoSporidium.OHS.JaminProcessor.ConvertToLuaTable(JToken.FromObject(value), false);
        ...
        public static string? Get_All(byte[] PostData, string ContentType, string directorypath, string batchparams, bool global)
        {
            string? dataforohs = null;
            string? output = null;
        ...
        public static string? Get(byte[] PostData, string ContentType, string directorypath, string batchparams, bool global)
        {
            string? dataforohs = null;
            string? output = null;
        ...
        public static string? User_Id(byte[] PostData, string ContentType, string batchparams)
        {
            string? dataforohs = null;
        ...
        public static string? User_GetWritekey(byte[] PostData, string ContentType, string batchparams)
        {
            string? dataforohs = null;
