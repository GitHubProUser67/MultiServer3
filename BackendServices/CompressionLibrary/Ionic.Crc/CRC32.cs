...
namespace Ionic.Crc
{
    ...
    public class CRC32
    {
...
#if VERBOSE
            Console.WriteLine();
            Console.WriteLine("private static readonly uint[] crc32Table = {");
        ...
        public static int Compute(byte[] data, int offset = 0)
        {
            CRC32 crc = new CRC32();

            crc.SlurpBlock(data, offset, data.Length);
