...
namespace Blaze3SDK.Components
{
    public static class GpsContentControllerComponentBase
    {
        ...
        public class Server : BlazeServerComponent<GpsContentControllerComponentCommand, GpsContentControllerComponentNotification, Blaze3RpcError>
        {
        ...
        public class Client : BlazeClientComponent<GpsContentControllerComponentCommand, GpsContentControllerComponentNotification, Blaze3RpcError>
        {
        ...
        public class Proxy : BlazeProxyComponent<GpsContentControllerComponentCommand, GpsContentControllerComponentNotification, Blaze3RpcError>
        {
