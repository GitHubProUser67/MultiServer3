...
namespace Blaze3SDK.Components
{
    public static class TournamentsComponentBase
    {
        ...
        public class Server : BlazeServerComponent<TournamentsComponentCommand, TournamentsComponentNotification, Blaze3RpcError>
        {
        ...
        public class Client : BlazeClientComponent<TournamentsComponentCommand, TournamentsComponentNotification, Blaze3RpcError>
        {
        ...
        public class Proxy : BlazeProxyComponent<TournamentsComponentCommand, TournamentsComponentNotification, Blaze3RpcError>
        {
