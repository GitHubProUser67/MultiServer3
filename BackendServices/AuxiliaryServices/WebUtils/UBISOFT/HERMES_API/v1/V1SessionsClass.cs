...
using System.Text;
using WebUtils.UBISOFT.Models.Hermes.v1;
using WebUtils.UBISOFT.Models.Hermes.v2;

namespace WebUtils.UBISOFT.HERMES_API.v1
{
    public static class V1SessionsClass
    {
        ...
        private static string GenerateGuidFromId(string id)
        {
            ...
            Array.Copy(MD5.Create().ComputeHash(Encoding.UTF8.GetBytes(id + "Ub1S0ft!!")), guidBytes, 16); // Take the first 16 bytes of the hash
