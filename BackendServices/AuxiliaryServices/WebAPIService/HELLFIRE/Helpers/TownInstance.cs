...
namespace WebAPIService.HELLFIRE.Helpers
{
    public class TownInstance
    {
        ...
        {
            string md5hash = NetHasher.ComputeMD5StringWithCleanup(input1 + "**H0mEIsG3reATW1tHH0meTYC000N!!!!!!!!!!!!!!");
            string sha512hash = NetHasher.ComputeSHA512StringWithCleanup("C0MeW1tHH0meTYC111NBaCKHOm3*!*!*!*!*!*!*!*!" + input2);
        ...
        {
            string md5hash = NetHasher.ComputeMD5StringWithCleanup(input1 + "**MyC1TY1sTH3be5T!!!!!!!!!!!!!!");
            string sha512hash = NetHasher.ComputeSHA512StringWithCleanup("1L0veH0mmmmeT1c000000nnnnn!!!!!" + input2);
            string result = (md5hash.Substring(1, 8) + sha512hash.Substring(2, 4) + md5hash.Substring(10, 4) + sha512hash.Substring(16, 4) + sha512hash.Substring(19, 16)).ToLower();
