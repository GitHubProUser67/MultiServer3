...
namespace WebAPIService.SSFW
{
    public class GuidGenerator
    {
        ...
        {
            string md5hash = NetHasher.ComputeMD5StringWithCleanup(input1 + "**H0mEIsG3reAT!!!!!!!!!!!!!!");
            string sha512hash = NetHasher.ComputeSHA512StringWithCleanup("C0MeBaCKHOm3*!*!*!*!*!*!*!*!" + input2);
