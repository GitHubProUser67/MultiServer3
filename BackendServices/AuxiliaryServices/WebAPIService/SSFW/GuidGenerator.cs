...
namespace WebAPIService.SSFW
{
    public class GuidGenerator
    {
        ...
        {
            string md5hash = NetHasher.ComputeMD5String(Encoding.UTF8.GetBytes(input1 + "**H0mEIsG3reAT!!!!!!!!!!!!!!"));
            string sha512hash = NetHasher.ComputeSHA512String(Encoding.UTF8.GetBytes("C0MeBaCKHOm3*!*!*!*!*!*!*!*!" + input2));
