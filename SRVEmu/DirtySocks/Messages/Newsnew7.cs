...
{
    public class Newsnew7 : AbstractMessage
    {
        ...
        public string? TOSAC_URL { get; set; } = "\"http://gos.ea.com/easo/editorial/common/2008/tos/tos.jsp?style=accept&lang=%s&platform=pc&from=%s\"";
        public string? TOSA_URL { get; set; } = "\"http://gos.ea.com/easo/editorial/common/2008/tos/tos.jsp?style=view&lang=%s&platform=pc&from=%s\"";
        public string? TOS_URL { get; set; } = "\"http://gos.ea.com/easo/editorial/common/2008/tos/tos.jsp?lang=%s&platform=pc&from=%s\"";
        ...
        public string? QOS_LOBBY { get; set; } = "159.153.105.1";
        ...
        public string? BUNDLE_PATH { get; set; } = "\"https://gos.ea.com/easo/editorial/Burnout/2008/livedata/bundle/\"";
        public string? NEWS_DATE { get; set; } = "2008.6.11 21:00:00";
        public string? NEWS_URL { get; set; } = "\"http://gos.ea.com/easo/editorial/common/2008/news/news.jsp?lang=%s&from=%s&game=Burnout&platform=pc\"";
        public string? AVAIL_DLC_URL { get; set; } = "\"https://gos.ea.com/easo/editorial/Burnout/2008/livedata/Ents.txt\" ";
        public string? AVATAR_URL { get; set; } = "\"http://www.criteriongames.com/pcstore/avatar.php?persona=%s\"";
        public string? AVATAR_URL_ENCRYPTED { get; set; } = "1";
        public string? STORE_DLC_URL { get; set; } = "\"http://pctrial.burnoutweb.ea.com/pcstore/store_dlc.php?lang=%s&from=%s&game=Burnout&platform=pc&env=live&nToken=%s&prodid=%s\"";
        public string? STORE_URL { get; set; } = "\"http://pctrial.burnoutweb.ea.com/t2b/page/index.php?lang=%s&from=%s&game=Burnout&platform=pc&env=live&nToken=%s\"";
        public string? STORE_URL_ENCRYPTED { get; set; } = "1";
        public string? ETOKEN_URL { get; set; } = "\"https://gos.ea.com/easo/editorial/common/2008/nucleus/nkeyToNucleusEncryptedToken.jsp?nkey=%s&signature=%s\"";
        public string? USE_ETOKEN { get; set; } = "1";
        public string? LIVE_NEWS_URL { get; set; } = "\"https://gos.ea.com/easo/editorial/Burnout/2008/livedata/main.jsp?lang=%s&from=%s&game=Burnout&platform=pc&env=live&nToken=%s\"";
        public string? LIVE_NEWS2_URL { get; set; } = "\"http://portal.burnoutweb.ea.com/loading.php?lang=%s&from=%s&game=Burnout&platform=pc&env=live&nToken=%s\"";
