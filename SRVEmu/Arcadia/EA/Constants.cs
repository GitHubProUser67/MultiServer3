namespace SRVEmu.Arcadia.EA.Constants;

public static class Mercs2
{
    public const string FeslAddress = "mercs2-pc.fesl.ea.com";
    public const string TheaterAddress = "mercs2-pc.theater.ea.com";
    public const int FeslServerPortPC = 18710;
    public const int TheaterServerPortPC = 18715;
}
...
public static class BadCompany2
{
    ...
    public const int FeslServerPortPs3 = 18171;
