...
namespace Horizon.SERVER.Config
{
    public class ServerSettings
    {
        ...
        /// (no valid defaults)
        /// </summary>
        public string MUMIp { get; set; } = InternetProtocolUtils.GetLocalIPAddress().ToString();
        ...
        /// </summary>
        public string? NATIp { get; set; } = InternetProtocolUtils.GetLocalIPAddress().ToString();
        ...
        /// </summary>
        public string MFSTransferURI { get; set; } = $"http://{InternetProtocolUtils.GetLocalIPAddress()}/";
        ...
        public string MUCGServerIP = InternetProtocolUtils.GetLocalIPAddress().ToString();
        ...
        public string BillingProviderIpAddr = InternetProtocolUtils.GetLocalIPAddress().ToString();
