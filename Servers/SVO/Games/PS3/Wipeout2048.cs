                        ...
                        case "/wox_ws/rest/lb/GetList":
                            ...
                            switch (method)
                            {
                                case "GET":
                                    ...
                                    byte[] GetList = Encoding.UTF8.GetBytes("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
                                            "<Leaderboard>" +
                                            "<GetList>" +
                            ...
                            switch (method)
                            {
                                case "GET":
                                    ...
                                    if (cookieHeader != null)
                                    {
                                        ...
                                        byte[] Leaderboard = Encoding.UTF8.GetBytes("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" +
                                            "<Leaderboard>" +
                                            "<GuessRanking>" +
                                        ...
                                        if (response.OutputStream.CanWrite)
                                        {
                                            try
                                            {
                                                response.ContentLength64 = Leaderboard.Length;
                                                response.OutputStream.Write(Leaderboard, 0, Leaderboard.Length);
                                            }
                                            catch (Exception)
                                            {
                                                // Not Important;
