...
namespace CryptoSporidium.Horizon.RT.Models
{
    ...
    public class MediusUniverseVariableInformationResponse : BaseLobbyExtMessage, IMediusResponse
    {
        ...
        public List<int> approvedList = new List<int> { 10421, 10994, 20244, 20043, 20464, 21093, 21094, 21614, 21624, 21834, 20371, 20374, 21324, 21514, 21784, 22073, 20464, 22500, 22920, 22924, 22930 };
