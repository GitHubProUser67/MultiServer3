...
using CryptoSporidium.Horizon.RT.Models.AntiCheat;
using CryptoSporidium.Horizon.LIBRARY.libAntiCheat.Models;

namespace CryptoSporidium.Horizon.LIBRARY.libAntiCheat
{
...
#nullable disable
        ...
        public static void anticheatGetVersion()
        {
            ...
            {
                LoggerAccessor.LogInfo("AntiCheat is not activated. \n Try setting AntiCheatOn=1 in your config.json file.");
            }
            else
            {
                LoggerAccessor.LogInfo($"{anticheatVersion}");
            }
            */
        }
