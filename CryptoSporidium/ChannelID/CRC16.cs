    ...
    public class CRC16
    {
        ...
        public static ushort CalcCcittCRC16(ReadOnlySpan<byte> bytes, int length)
        {
            ...
            while (length-- > 0)
            {
                ...
                crc16 = (ushort)(crc16 << 8 ^ HomeccittCrc16Table[tableIndex]);
            }

            if (BitConverter.IsLittleEndian) // Home expect big endian data.
                crc16 = SwapEndian(crc16);
