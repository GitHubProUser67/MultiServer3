...
namespace CryptoSporidium.ChannelID
{
  public class SceneKey
  {
    ...
    public override string ToString()
    {
      ...
      stringBuilder.AppendFormat("{0:x2}{1:x2}{2:x2}{3:x2}-", (object) m_A[0], (object) m_A[1], (object) m_A[2], (object) m_A[3]);
      stringBuilder.AppendFormat("{0:x2}{1:x2}-", (object) m_B[0], (object) m_B[1]);
      stringBuilder.AppendFormat("{0:x2}{1:x2}-", (object) m_C[0], (object) m_C[1]);
      stringBuilder.AppendFormat("{0:x2}{1:x2}-", (object) m_D[0], (object) m_D[1]);
      stringBuilder.AppendFormat("{0:x2}{1:x2}{2:x2}{3:x2}{4:x2}{5:x2}", (object) m_E[0], (object) m_E[1], (object) m_E[2], (object) m_E[3], (object) m_E[4], (object) m_E[5]);
