...
namespace PSMultiServer.Addons.Horizon.Server.Database
{
    public class DbController
    {
        ...
        {
            // Be VERY CAREFULL if you use same file for all the componants, it's not a good idea
            // You wanna put the db files in each directory.
            // Not doing so result in a crash.
