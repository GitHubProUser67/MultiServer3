        ...
        public async Task Start()
        {
            ...
            _scertHandler.OnChannelMessage += async (channel, message) =>
            {
                ...
                */
                ...
                ServerConfiguration.LogInfo($"[BWPS] - Received Message: {message} on {channel}");
                ...
                if (message.Content.ReadableBytes == 18)
                {
                    ...
                    ServerConfiguration.LogInfo($"[BWPS] - Sending 18 len response");
                ...
                else if (message.Content.ReadableBytes == 18 && message.Content.GetByte(message.Content.ReaderIndex + 2) != 0x01)
                {
                    if (message.Content.ReadableBytes == 18)
                    {
                        ...
                        ServerConfiguration.LogInfo($"[BWPS] - Sending 18 response");
                ...
                if (message.Content.ReadableBytes == 6)
                {
                    ...
                    ServerConfiguration.LogInfo($"[BWPS] - Sending 6 len response ");
        ...
        protected void ProcessMessage(ScertDatagramPacket packet)
        {
            ...
            switch (message)
            {
                ...
                */
                default:
                    {
                        ServerConfiguration.LogInfo($"[BWPS] - UNHANDLED RT MESSAGE: {message}");
