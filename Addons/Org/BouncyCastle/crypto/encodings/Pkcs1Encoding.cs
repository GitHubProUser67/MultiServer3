...
namespace MultiServer.Addons.Org.BouncyCastle.Crypto.Encodings
{
    /**
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property MultiServer.Addons.Org.BouncyCastle.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "MultiServer.Addons.Org.BouncyCastle.Pkcs1.Strict";
