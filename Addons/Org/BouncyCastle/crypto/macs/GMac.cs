...
using MultiServer.Addons.Org.BouncyCastle.Crypto.Modes;
...
namespace MultiServer.Addons.Org.BouncyCastle.Crypto.Macs
{
        ...
        : IMac
    {
        ...
        /// <summary>
        /// Initialises the GMAC - requires a <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.ParametersWithIV"/> 
        /// providing a <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.KeyParameter"/> and a nonce.
        /// </summary>
