...
namespace MultiServer.Addons.Org.BouncyCastle.Crypto.Digests
{
	...
	/// based on the <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Digests.SkeinEngine"/>
		...
		: IDigest, IMemoable
	{
		...
		/// </summary>
		/// See <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
