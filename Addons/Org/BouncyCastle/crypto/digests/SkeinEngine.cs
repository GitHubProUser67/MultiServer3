...
namespace MultiServer.Addons.Org.BouncyCastle.Crypto.Digests
{

    /// <summary>
    /// Implementation of the Skein family of parameterised hash functions in 256, 512 and 1024 bit block
    /// sizes, based on the <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Digests.SkeinDigest"/> and <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="MultiServer.Addons.Org.BouncyCastle.Crypto.Parameters.SkeinParameters"/> for
