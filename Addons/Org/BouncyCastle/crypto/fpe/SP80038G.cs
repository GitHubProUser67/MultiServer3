...
namespace MultiServer.Addons.Org.BouncyCastle.Crypto.Fpe
{
    /*
    ...
    {
        internal static readonly string FPE_DISABLED = "MultiServer.Addons.Org.BouncyCastle.Fpe.Disable";
        internal static readonly string FF1_DISABLED = "MultiServer.Addons.Org.BouncyCastle.Fpe.Disable_Ff1";
